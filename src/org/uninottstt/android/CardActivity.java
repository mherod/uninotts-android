...
import org.uninottstt.android.service.CardProviderModule;
import org.uninottstt.android.service.LiveService;
import org.uninottstt.android.service.UserSyncModule;
import org.uninottstt.android.util.DepthPageTransformer;
import org.uninottstt.android.util.ViewHelpers;
...
public class CardActivity extends Activity implements Runnable {
	...
	private boolean updateCardsView() {
		...
		boolean isLoadingView = isLoadingView();
